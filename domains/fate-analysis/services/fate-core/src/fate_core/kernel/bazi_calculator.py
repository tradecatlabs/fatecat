...
外部库依赖注入 (相对路径从项目根目录):
├── tools/reference-repos/github/lunar-python-master     # 核心历法库 (强制依赖)
├── tools/reference-repos/github/bazi-1-master           # 五行量化、神煞数据
├── tools/reference-repos/github/sxwnl-master            # 寿星万年历 (Node.js)
├── tools/reference-repos/github/iztro-main              # 紫微斗数 (TypeScript)
├── tools/reference-repos/github/fortel-ziweidoushu-main # 专业紫微斗数
├── tools/reference-repos/github/mikaboshi-main          # 风水罗盘 (Rust)
├── tools/reference-repos/github/Chinese-Divination-master # 六爻/梅花/奇门
├── tools/reference-repos/github/Iching-master           # 易经系统
...
from fate_core.kernel.ming_gua import calc_ming_gua
from fate_core.kernel.solar_time import (
    calc_true_solar_time as calc_true_solar_time,
)
from fate_core.kernel.solar_time import (
...
EXTERNAL_LIBS_DIR = FATE_VENDOR_ROOT / "github"
...
# 核心依赖强制导入 - 失败即终止
from datas import day_shens, g_shens, jinbuhuan, month_shens, shens_infos, tiaohous, year_shens  # noqa: E402
from ganzhi import gan5, gan_desc, gan_health, ten_deities, zhi5, zhi_desc  # noqa: E402
from sizi import summarys as sizi_summarys  # noqa: E402
...
class BaziCalculator:
    ...
    def _calc_true_solar_time(self, dt: datetime, longitude: float, latitude: float = None) -> datetime:
        ...
        """
        return calculate_true_solar_time(dt, longitude, latitude)
    ...
    def _calc_true_solar_time_detail(
        ...
        """
        return calculate_true_solar_time_detail(dt, longitude, latitude)
