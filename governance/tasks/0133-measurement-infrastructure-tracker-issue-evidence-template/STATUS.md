...
| Field | Value |
| --- | --- |
| Task | 0133 measurement-infrastructure-tracker-issue-evidence-template |
| Priority | P0 |
| Phase | SHIP |
...
- None identified for local tracker issue evidence template implementation.
...
- Filled tracker issue evidence bundle with sanitized issue refs and artifact hashes.
...
- Current validation artifacts:
  - `/tmp/fatecat-secret-scan-external-validation-tracker-issue-evidence-template-0133.json`
  - `/tmp/fatecat-tracker-issue-evidence-template-0133-smoke/external-validation-tracker-issue-evidence-template.json`
  - `/tmp/fatecat-tracker-issue-evidence-template-0133-smoke/EXTERNAL_VALIDATION_TRACKER_ISSUE_EVIDENCE_TEMPLATE.md`
  - `/tmp/fatecat-local-ci-external-validation-tracker-issue-evidence-template-0133-precommit/external-validation-tracker-issue-evidence-template.json`
  - `/tmp/fatecat-local-ci-external-validation-tracker-issue-evidence-template-0133-precommit/EXTERNAL_VALIDATION_TRACKER_ISSUE_EVIDENCE_TEMPLATE.md`
  - `/tmp/fatecat-local-ci-external-validation-tracker-issue-evidence-template-0133-precommit/summary.json`

Precommit quick CI passed while the 0133 diff was intentionally uncommitted, so `dirtyCount` / `untrackedCount` in that summary are not final ship evidence.
