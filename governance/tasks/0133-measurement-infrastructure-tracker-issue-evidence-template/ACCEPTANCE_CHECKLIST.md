...
### TP-01 scope and tracker issue evidence template boundary confirmation

Verify: roadmap 6.27 and existing issue evidence gate reviewed.
...
Verify: local-ci has a tracker issue evidence template step and focused pytest includes the tracker issue evidence template test.
...
Verify: scripts/audit/tests AGENTS, roadmap and task index mention the tracker issue evidence template.
...
- [x] Generator emits bundle skeleton.
