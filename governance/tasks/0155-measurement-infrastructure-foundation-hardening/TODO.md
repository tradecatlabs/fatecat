...
[x] TP-04 | P0 | 补齐自动 CI 与发布证明 | Verify: workflow regression + action syntax + current release proof | Gate: 最终提交拥有真实远端 quick CI 证据 | Parallelizable: No
...
[x] TP-07 | P0 | 性能、质量与交付收口 | Verify: quick CI + performance baseline + task review + closeout + remote CI | Gate: 本地实现无 BLOCK；外部人工/live 门禁真实保留 | Parallelizable: No
