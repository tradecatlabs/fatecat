...
- 无新的 Not Started 叶子；TP-04 与 TP-07 正在等待 Git 提交、推送、远端 CI 和 closeout。
...
| TP-04 | ROOT | 1 | TP-03 | No | In Progress | quick workflow 合同与本地 quick CI 通过；等待最终提交对应的远端 run | 最终提交尚未生成 | 提交并推送后核对 GitHub Actions |
...
| TP-07 | ROOT | 1 | TP-06 | No | In Progress | 全量 pytest 638 passed/1 skipped，修复唯一文档失败后定向通过；local-ci quick 446 passed；等待提交、远端 CI 与 closeout | 远端 CI/closeout 未完成 | 完成 Git 交付后收口 |
...
- TP-04: status=In Progress; verifier_context=远端 quick CI 待核验
- TP-05: status=Done; verifier_context=自审
- TP-06: status=Done; verifier_context=自审
- TP-07: status=In Progress; verifier_context=Git 交付与 closeout 待完成
