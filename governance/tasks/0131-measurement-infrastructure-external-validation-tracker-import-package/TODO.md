...
[x] TP-01 | P0 | 确认 tracker import package 范围和证据链 | Verify: roadmap 6.25 与 issue export script | Gate: 不依赖真实外部凭证或 tracker 权限 | Parallelizable: No
...
[x] TP-03 | P0 | 接入 local-ci 和 regression | Verify: local-ci contains tracker import package step and focused pytest includes test | Gate: summary artifact path exposed | Parallelizable: No
[x] TP-04 | P0 | 同步 AGENTS/roadmap/task index | Verify: rg tracker import package docs | Gate: 文档不声明 issue created 或 live passed | Parallelizable: No
