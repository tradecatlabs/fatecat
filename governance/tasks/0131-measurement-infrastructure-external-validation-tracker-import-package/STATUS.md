...
| Field | Value |
| --- | --- |
| Task | 0131 measurement-infrastructure-external-validation-tracker-import-package |
| Priority | P0 |
| Phase | SHIP |
...
- None identified for local tracker import package implementation.
...
- Current validation artifacts:
  - `/tmp/fatecat-secret-scan-external-validation-tracker-import-package-0131.json`
  - `/tmp/fatecat-tracker-import-package-0131-smoke/external-validation-tracker-import-package.json`
  - `/tmp/fatecat-tracker-import-package-0131-smoke/EXTERNAL_VALIDATION_TRACKER_IMPORT_PACKAGE.md`
  - `/tmp/fatecat-local-ci-external-validation-tracker-import-package-0131-precommit/external-validation-tracker-import-package.json`
  - `/tmp/fatecat-local-ci-external-validation-tracker-import-package-0131-precommit/external-validation-tracker-import-package/`
  - `/tmp/fatecat-local-ci-external-validation-tracker-import-package-0131-precommit/EXTERNAL_VALIDATION_TRACKER_IMPORT_PACKAGE.md`
  - `/tmp/fatecat-local-ci-external-validation-tracker-import-package-0131-precommit/summary.json`

Precommit quick CI passed while the 0131 diff was intentionally uncommitted, so `dirtyCount` / `untrackedCount` in that summary are not final ship evidence.
