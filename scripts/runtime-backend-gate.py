...
def _validate_registry(
    *,
    ...
    _check(
        checks,
        "postgres:worker_heartbeat_polling_smoke_baseline",
        postgres["implementationStatus"] == "worker_heartbeat_polling_smoke_baseline",
    ...
    _check(
        checks,
        "postgres:worker_heartbeat_polling_smoke_registered",
        "bash scripts/postgres-worker-heartbeat-polling-smoke.sh" in postgres["externalVerification"]
        and "bash scripts/postgres-worker-heartbeat-polling-smoke.sh --allow-missing" in postgres["localVerification"]
        and postgres["capabilities"].get("workerHeartbeatPolling")
