...
- 黄历/择日、建除、六爻、梅花、奇门、大六壬、风水九星、姓名合婚等仍为 `planned`，不得混入综合八字默认报告。
- Web/API/Bot/Markdown 展示层不回显非北京类真实出生地区。

## 新增门禁

| 门禁 | 路径 | 说明 |
| --- | --- | --- |
| 节气 golden | `tests/test_solar_terms_golden.py` | 全量对照 `assets/data/calendar/solar_terms/golden/solar_terms_1900_2030.json` 与 `lunar-python` 的节气时间容差；抽样硬锁月令、立春年界、真太阳时入参边界和起运样本。 |
