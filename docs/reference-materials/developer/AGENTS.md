...
- docs smoke 位于 `scripts/developer-docs-smoke.sh`，负责验证示例文件、OpenAPI 和 sandbox fixture；developer platform gate 位于 `scripts/developer-platform-gate.sh`，负责锁定 SDK/package、token 和 changelog 边界。
